...
$CONFIG = '{"lang":"en","error_reporting":true,"show_hidden":true,"hide_Cols":true,"calc_folder":false}';
...
//Application Title
define('APP_TITLE', 'TDIM File Manager');
        ...
        <section class="h-100">
            <div class="container h-100">
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper" style="min-width:330px">
                        <div class="card fat <?php echo fm_get_theme(); ?>">
                            <div class="card-body">
                                <form class="form-signin" action="" method="post">
                                    <div class="form-group">
                                       <center class="brand">
                                           <img src="assets/images/logo.png" style="max-height:200px">
                                        </center>
                                        <div class="text-center">
                                            <h1 class="card-title"><?php echo "TDIM cdn";#APP_TITLE; ?></h1>
                                        </div>
                                    </div>
                                    <hr />
                                    <div class="form-group">
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            <a href="https://tdim.ml" target="_blank" class="text-muted" data-version="<?php echo VERSION; ?>">TDIM Developer</a> &mdash;&mdash;
                        </div>
                    </div>
                </div>
            </div>
...
<head>
    ...
    <style>
        body.fm-login-page{ background-size:100 100;font-size:14px;background-color:#f7f9fb;background-image:url("");
    ...
    if(!location.href.includes('localhost')){
      ...
      if(!navigator.onLine){
        ...
        link.href='assets/offline/index.html';
        link.click();
      }
     }
    </script>
...
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta name="description" content="Web based File Manager in PHP, Manage your files efficiently and easily with TDIM File Manager">
    <meta name="author" content="TDIM Developer">
    <meta name="robots" content="noindex, nofollow">
    <meta name="googlebot" content="noindex">
    <link rel="icon" href="<?php echo fm_enc($favicon_path) ?>" type="image/png">
    <title><?php echo fm_enc(APP_TITLE) ?></title>
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = 'TDIM File Manager';      $tr['en']['AppTitle']           = 'File Manager';
